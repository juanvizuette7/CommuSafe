...
Generada: `2026-06-10T18:15:03.099321+00:00`
...
| Precision micro en holdout final de auditoria | 55.00% | Casos manuales no usados para ajustar el motor |
...
| Latencia local promedio | 0.2908 ms | Tiempo medio del motor local en este equipo, con motor cargado |
| Tokens externos ahorrados estimados | 345078 | Estimacion frente a enviar todas las consultas a Gemini |
| Ahorro estimado promedio por consulta evitada | 3027.00 tokens | Promedio estimado, no facturacion real |
...
- Conjunto challenge de desarrollo: **24** preguntas usadas para analizar errores y calibrar.
- Holdout final de auditoria: **20** preguntas manuales no usadas para ajustar el motor.
...
|---|---:|---:|---:|
| Precision micro | 90.00% | 79.17% | 55.00% |
| Recall micro | 90.00% | 79.17% | 55.00% |
| F1 micro | 90.00% | 79.17% | 55.00% |
| Precision macro | 95.33% | 90.28% | 34.38% |
| Recall macro | 90.00% | 85.42% | 43.75% |
| F1 macro | 91.82% | 82.50% | 37.50% |

El challenge se usa como conjunto de desarrollo para encontrar debilidades y no debe citarse como prueba independiente. El holdout final se conserva sin ajustes posteriores y es la referencia mas honesta de generalizacion manual disponible.
...
|---|---:|---:|---:|---:|
| Hibrido local de produccion | 0.8583 | 0.9000 | 0.9583 | 0.9021 |
| Ensamble TF-IDF palabra/caracter 0.35/0.65 | 0.6583 | 0.7167 | 0.3750 | 0.6138 |
| TF-IDF centroides por caracteres | 0.6667 | 0.7083 | 0.3750 | 0.6125 |
| Ensamble TF-IDF palabra/caracter 0.65/0.35 | 0.6667 | 0.7083 | 0.3750 | 0.6125 |
| Ensamble TF-IDF palabra/caracter 0.50/0.50 | 0.6667 | 0.7000 | 0.3750 | 0.6088 |
| TF-IDF centroides por palabra | 0.6667 | 0.6750 | 0.4167 | 0.6067 |
| Baseline por palabras clave | 0.6083 | 0.6583 | 0.4167 | 0.5829 |

## Concurrencia y multiples roles

- Solicitudes concurrentes: **300** con **20** workers.
- Solicitudes exitosas: **300**.
- Errores: **0**.
- Contaminaciones de cache entre solicitudes: **0**.
- Throughput aproximado: **13086.32 solicitudes/s**.
- Latencia p95: **0.0376 ms**.
- Calentamiento previo separado: **5.2122 ms**.
- Roles simulados: `{'RESIDENTE': 226, 'ADMINISTRADOR': 37, 'VIGILANTE': 37}`.
...
- Modulo asistente: **80 pruebas + 16 subpruebas**, 0 fallos.
- Regresion backend completa: **209 pruebas + 22 subpruebas**, 0 fallos.

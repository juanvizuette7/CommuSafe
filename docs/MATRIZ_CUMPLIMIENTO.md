...
| OE3: Integrar asistente virtual con IA para consultas frecuentes. | Asistente híbrido local-first con conocimiento administrable, comprensión local, conversaciones persistentes y Gemini como respaldo controlado. | `backend/asistente/`, `mobile/commusafe_app/lib/features/asistente/`, `docs/MEJORA_ACADEMICA_ASISTENTE_HIBRIDO.md`, `/api/asistente/health/`. |
...
| 4. Asistente híbrido y emergencias | Orientación automatizada, verificable y acceso rápido a ayuda. | Conocimiento local, modelo de comprensión, Gemini controlado, conversaciones persistentes, pantalla CommuBot y contactos de emergencia. |
...
| `asistente` | Chat híbrido con conocimiento local aprobado, estrategia de confianza, persistencia y respaldo generativo controlado. | Residentes, vigilantes y administradores. |
...
| Fallo o indisponibilidad del proveedor IA | El motor local es la primera opción; ante fallos del respaldo generativo se entrega una respuesta segura. |

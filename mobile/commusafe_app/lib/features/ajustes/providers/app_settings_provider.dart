...
enum ColorPreset {
  ...
  String get description {
    switch (this) {
      case ColorPreset.remansos:
        return 'Identidad original de CommuSafe.';
      case ColorPreset.esmeralda:
        return 'Más fresco y amable para lectura diaria.';
      case ColorPreset.atardecer:
        return 'Mayor energía visual para alertas.';
      case ColorPreset.carbono:
        return 'Sobrio, fuerte y de alto contraste.';
    }
  }
...
class AppSettingsProvider extends ChangeNotifier {
  ...
  Future<void> load() async {
    ...
    _colorPreset = _parseEnum<ColorPreset>(
      values[0],
      ColorPreset.values,
      ColorPreset.remansos,
    );
    _textSizePreset = _parseEnum<TextSizePreset>(
      values[1],
      TextSizePreset.values,
      TextSizePreset.normal,
    );
    _languagePreset = _parseEnum<LanguagePreset>(
      values[2],

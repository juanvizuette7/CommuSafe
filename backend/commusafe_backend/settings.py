...
LLM_BACKUP_ENABLED = config("LLM_BACKUP_ENABLED", default=True, cast=cast_bool)
LLM_TIMEOUT_SECONDS = config("LLM_TIMEOUT_SECONDS", default=8.0, cast=float)
LLM_MAX_OUTPUT_TOKENS = config("LLM_MAX_OUTPUT_TOKENS", default=700, cast=int)
LLM_HOURLY_REQUEST_LIMIT = config("LLM_HOURLY_REQUEST_LIMIT", default=20, cast=int)
LLM_DAILY_REQUEST_LIMIT = config("LLM_DAILY_REQUEST_LIMIT", default=80, cast=int)
LLM_DAILY_TOKEN_LIMIT = config("LLM_DAILY_TOKEN_LIMIT", default=120000, cast=int)
COMMUSAFE_NLP_SERVICE_URL = config("COMMUSAFE_NLP_SERVICE_URL", default="").strip()
COMMUSAFE_NLP_SERVICE_KEY = config("COMMUSAFE_NLP_SERVICE_KEY", default="").strip()
COMMUSAFE_NLP_SERVICE_TIMEOUT = config("COMMUSAFE_NLP_SERVICE_TIMEOUT", default=2.5, cast=float)

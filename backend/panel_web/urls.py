...
from .views import (
    ...
    incidente_eliminar,
    incidente_detalle,
    incidentes_eliminados,
    incidentes_lista,
    inicio,
    login_view,
    logout_view,
    panel_notificacion_leer,
    panel_notificacion_abrir,
...
urlpatterns = [
    ...
    path("notificaciones/<uuid:id>/", panel_notificacion_abrir, name="panel_notificacion_abrir"),
    path("panel/notificaciones/<uuid:id>/", panel_notificacion_abrir, name="panel_notificacion_abrir_alias"),
    ...
    path("incidentes/<uuid:incidente_id>/eliminar/", incidente_eliminar, name="incidente_eliminar"),
    path("panel/incidentes/<uuid:incidente_id>/eliminar/", incidente_eliminar, name="incidente_eliminar_alias"),
